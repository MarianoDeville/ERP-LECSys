...
public class InformeAlumno extends VentanaModelo {
	...
	public InformeAlumno(String nombreVentana) {
		...
		contenedor.putConstraint(SpringLayout.EAST, lblLegajo, 50, SpringLayout.WEST, lblLegajo);
		panel.add(lblLegajo);
		...
		contenedor.putConstraint(SpringLayout.EAST, lblNombre, 0, SpringLayout.EAST, lblLegajo);
		panel.add(lblNombre);
		...
		contenedor.putConstraint(SpringLayout.EAST, lblApellido, 0, SpringLayout.EAST, lblLegajo);
		...
		contenedor.putConstraint(SpringLayout.EAST, lblCurso, 0, SpringLayout.EAST, lblLegajo);
		panel.add(lblCurso);
		
		txtCurso = new JTextField();
		contenedor.putConstraint(SpringLayout.NORTH, txtCurso, -2, SpringLayout.NORTH, lblCurso);
		contenedor.putConstraint(SpringLayout.WEST, txtCurso, 5, SpringLayout.EAST, lblCurso);
		panel.add(txtCurso);
		txtCurso.setColumns(15);
		
		JLabel lblAsistencia = new JLabel("Asistencia");
		contenedor.putConstraint(SpringLayout.NORTH, lblAsistencia, 30, SpringLayout.SOUTH, lblCurso);
		...
		contenedor.putConstraint(SpringLayout.WEST, lblEscrito, 150, SpringLayout.WEST, panel);
		...
		contenedor.putConstraint(SpringLayout.WEST, lblOral, 10, SpringLayout.EAST, lblEscrito);
		panel.add(lblOral);
		...
		contenedor.putConstraint(SpringLayout.WEST, lblComportamiento, 10, SpringLayout.EAST, lblOral);
		...
		contenedor.putConstraint(SpringLayout.WEST, txtEscrito1, 5, SpringLayout.EAST, lblPeriodo1);
		panel.add(txtEscrito1);
		txtEscrito1.setColumns(5);

		txtOral1 = new JTextField();
		contenedor.putConstraint(SpringLayout.NORTH, txtOral1, 0, SpringLayout.NORTH, txtEscrito1);
		contenedor.putConstraint(SpringLayout.WEST, txtOral1, 5, SpringLayout.EAST, txtEscrito1);
		panel.add(txtOral1);
		txtOral1.setColumns(5);
		...
		contenedor.putConstraint(SpringLayout.WEST, txtComportamiento1, 5, SpringLayout.EAST, txtOral1);
		panel.add(txtComportamiento1);
		txtComportamiento1.setColumns(5);
		...
		contenedor.putConstraint(SpringLayout.WEST, txtEscrito2, 5, SpringLayout.EAST, lblPeriodo2);
		panel.add(txtEscrito2);
		txtEscrito2.setColumns(5);

		txtOral2 = new JTextField();
		contenedor.putConstraint(SpringLayout.NORTH, txtOral2, 0, SpringLayout.NORTH, txtEscrito2);
		contenedor.putConstraint(SpringLayout.WEST, txtOral2, 5, SpringLayout.EAST, txtEscrito2);
		panel.add(txtOral2);
		txtOral2.setColumns(5);
		...
		contenedor.putConstraint(SpringLayout.WEST, txtComportamiento2, 5, SpringLayout.EAST, txtOral2);
		panel.add(txtComportamiento2);
		txtComportamiento2.setColumns(5);
		...
		contenedor.putConstraint(SpringLayout.WEST, txtFinalEscrito, 5, SpringLayout.EAST, lblFinal);
		panel.add(txtFinalEscrito);
		txtFinalEscrito.setColumns(5);
		
		txtFinalOral = new JTextField();
		contenedor.putConstraint(SpringLayout.NORTH, txtFinalOral, 0, SpringLayout.NORTH, txtFinalEscrito);
		contenedor.putConstraint(SpringLayout.WEST, txtFinalOral, 5, SpringLayout.EAST, txtFinalEscrito);
		panel.add(txtFinalOral);
		txtFinalOral.setColumns(5);
		...
		contenedor.putConstraint(SpringLayout.WEST, txtFinalComportamiento, 5, SpringLayout.EAST, txtFinalOral);
		panel.add(txtFinalComportamiento);
		txtFinalComportamiento.setColumns(5);

		btnImprimir = new JButton("Imprimir");
		contenedor.putConstraint(SpringLayout.SOUTH, btnImprimir, -10, SpringLayout.SOUTH, panel);
		contenedor.putConstraint(SpringLayout.EAST, btnImprimir, -168, SpringLayout.EAST, panel);
		panel.add(btnImprimir);
		
		btnVolver = new JButton("Volver");
		contenedor.putConstraint(SpringLayout.SOUTH, btnVolver, 0, SpringLayout.SOUTH, btnImprimir);
		contenedor.putConstraint(SpringLayout.EAST, btnVolver, -39, SpringLayout.WEST, btnImprimir);
		panel.add(btnVolver);
	}
}
