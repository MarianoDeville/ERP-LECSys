...
CREATE TABLE IF NOT EXISTS `LECSys1`.`compras` (
  ...
  `fecha` DATE NULL,
  `idAutoriza` INT NULL,
  `sectorSolicitanta` VARCHAR(45) NULL,
...
-- -----------------------------------------------------
-- Table `LECSys1`.`cotización`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `LECSys1`.`cotización` (
  ...
  INDEX `Insumos_idx` (`idInsumos` ASC) VISIBLE,
