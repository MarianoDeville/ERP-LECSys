...
-- Schema LECSys2.0
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `LECSys2.0` DEFAULT CHARACTER SET utf8 ;
USE `LECSys2.0` ;

-- -----------------------------------------------------
-- Table `LECSys2.0`.`persona`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `LECSys2.0`.`persona` (
...
-- -----------------------------------------------------
-- Table `LECSys2.0`.`empleados`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `LECSys2.0`.`empleados` (
  ...
  CONSTRAINT `idPersona`
    ...
    REFERENCES `LECSys2.0`.`persona` (`idPersona`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `LECSys2.0`.`curso`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `LECSys2.0`.`curso` (
  ...
  CONSTRAINT `idProfesor`
    ...
    REFERENCES `LECSys2.0`.`empleados` (`idEmpleado`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `LECSys2.0`.`grupoFamiliar`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `LECSys2.0`.`grupoFamiliar` (
...
-- -----------------------------------------------------
-- Table `LECSys2.0`.`alumnos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `LECSys2.0`.`alumnos` (
  ...
  CONSTRAINT `idCurso`
    FOREIGN KEY (`idCurso`)
    REFERENCES `LECSys2.0`.`curso` (`idCurso`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `idGrupoFamiliar`
    FOREIGN KEY (`idGrupoFamiliar`)
    REFERENCES `LECSys2.0`.`grupoFamiliar` (`idGrupoFamiliar`)
    ON DELETE SET NULL
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `LECSys2.0`.`estadísticas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `LECSys2.0`.`estadísticas` (
...
-- -----------------------------------------------------
-- Table `LECSys2.0`.`cobros`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `LECSys2.0`.`cobros` (
  ...
  CONSTRAINT `estadisticas`
    ...
    REFERENCES `LECSys2.0`.`estadísticas` (`idEstadísticas`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `LECSys2.0`.`usuarios`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `LECSys2.0`.`usuarios` (
...
-- -----------------------------------------------------
-- Table `LECSys2.0`.`faltas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `LECSys2.0`.`faltas` (
  ...
  CONSTRAINT `idAlumnos`
    ...
    REFERENCES `LECSys2.0`.`alumnos` (`idAlumno`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `LECSys2.0`.`proveedores`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `LECSys2.0`.`proveedores` (
...
-- -----------------------------------------------------
-- Table `LECSys2.0`.`pagos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `LECSys2.0`.`pagos` (
  ...
  CONSTRAINT `idProveedor`
    ...
    REFERENCES `LECSys2.0`.`proveedores` (`idproveedores`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `LECSys2.0`.`valorCuota`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `LECSys2.0`.`valorCuota` (
...
-- -----------------------------------------------------
-- Table `LECSys2.0`.`diasCursado`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `LECSys2.0`.`diasCursado` (
...
-- -----------------------------------------------------
-- Table `LECSys2.0`.`registroActividad`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `LECSys2.0`.`registroActividad` (
  ...
  CONSTRAINT `idUsuarios`
    ...
    REFERENCES `LECSys2.0`.`usuarios` (`idUsuarios`)
    ON DELETE SET NULL
    ON UPDATE SET NULL)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `LECSys2.0`.`examenes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `LECSys2.0`.`examenes` (
...
-- -----------------------------------------------------
-- Table `LECSys2.0`.`insumos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `LECSys2.0`.`insumos` (
...
-- -----------------------------------------------------
-- Table `LECSys2.0`.`compras`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `LECSys2.0`.`compras` (
  ...
  CONSTRAINT `idInsumo`
    ...
    REFERENCES `LECSys2.0`.`insumos` (`idinsumos`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
